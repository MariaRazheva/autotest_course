...
def flatten_and_sort(array):
    """
    Получить одномерный отсортированный по возрастанию список, включающий все числа из входного списка
    :param array: двумерный список чисел
    :return: одномерный отсортированный по возрастанию список
    """
    result_list = []
    while len(array) > 0:
        result_list.extend(array[-1])
        array.pop()
    result_list.sort()
    return result_list
