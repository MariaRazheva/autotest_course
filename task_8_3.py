...
def segment(tup1, tup2):
    """
    возвращает сумму всех координат двух полученных точек, выбрасывает исключение, если полученные координаты не
     являются числами
    :param tup1: кортеж, состоящий из двух координат первой точки
    :param tup2: кортеж, состоящий из двух координат второй точки
    :return: сумму всех координат либо исключение с текстом ошибки, написанным задом наперёд
    """
    try:
        sum = tup1[0] + tup1[1] + tup2[0] + tup2[1]
