...
def global_function():
    """
    создаёт переменную msg с заданным значением и меняет значение переменной на 2; возвращает это значение
    :return: переменная msg
    """
    msg = 1

    def local_function():
        """
        меняет на 2 значение переменной msg из объемлющей функции
        :return: ---
        """
        nonlocal msg
        msg = 2
